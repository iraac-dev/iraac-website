...
nav.main-nav ul { list-style: none; display: flex; flex-direction: column; gap: 12px; margin: 0; padding: 0; }
...
/* Dropdown inline display (always, since nav is a full overlay) */
li.nav-dropdown { position: static; }
.nav-dd-toggle { background: none; border: none; color: var(--sand); font-size: 0.92rem; font-weight: 500; cursor: pointer; padding: 0; border-bottom: 2px solid transparent; padding-bottom: 4px; font-family: inherit; width: 100%; text-align: left; padding: 4px 0; }
...
.nav-dd-menu a { display: block; padding: 6px 12px; color: var(--sand); font-size: 0.85rem; white-space: nowrap; border-bottom: none !important; }
.nav-dd-menu a:hover { background: rgba(250,246,239,0.06); color: var(--ochre); }
.nav-dropdown:hover .nav-dd-menu, .nav-dropdown:focus-within .nav-dd-menu { display: none; }
.nav-dropdown.open .nav-dd-menu { display: block; }
/* Login button — always visible, alongside the toggle */
...
.nav-toggle { display: block; background: none; border: none; color: var(--cream); font-size: 1.6rem; cursor: pointer; }
