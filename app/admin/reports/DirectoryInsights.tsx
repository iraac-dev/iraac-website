...
export default function DirectoryInsights() {
        ...
        <div className="admin-summary-cards">
          ...
          <div className="admin-mini-card">
            <div className="admin-mini-stat">
              {services.filter((s) => s.suburb === "Nowra").length}
            </div>
            <div className="admin-mini-label">Nowra services</div>
          </div>
          <div className="admin-mini-card">
            <div className="admin-mini-stat">
              {services.filter((s) => s.isAboriginalLed).length}
            </div>
                  ...
                  .map(([status, count]) => {
                    ...
                    return (
                      <div className="admin-report-bar-row" key={status}>
                        <span className="admin-report-bar-label">
      ...
      {(!stats || stats.total === 0) && (
        <div className="admin-empty">
          ...
          <p className="admin-empty-hint">
            Referral reports will populate once community members submit
            requests for help from services.
          </p>
        </div>
      )}
    </div>
