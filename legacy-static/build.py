...
nav.main-nav ul { list-style: none; display: flex; gap: 20px; margin: 0; padding: 0; align-items: center; }
...
/* Dropdown — click to open, right-aligned */
li.nav-dropdown { position: relative; list-style: none; }
.nav-dd-toggle { background: none; border: none; color: var(--sand); font-size: 0.92rem; font-weight: 500; cursor: pointer; padding: 0; border-bottom: 2px solid transparent; padding-bottom: 4px; font-family: inherit; white-space: nowrap; }
.nav-dd-toggle:hover, li.nav-dropdown.active .nav-dd-toggle { color: var(--ochre); border-bottom-color: var(--ochre); }
.nav-dd-menu { display: none; position: absolute; top: 100%; right: 0; background: var(--charcoal); border: 1px solid rgba(250,246,239,0.12); border-radius: 6px; padding: 8px 0; min-width: 200px; box-shadow: 0 8px 24px rgba(0,0,0,0.4); z-index: 100; margin-top: 6px; }
.nav-dd-menu::before { content: ""; position: absolute; top: -6px; right: 18px; width: 12px; height: 12px; background: var(--charcoal); border-left: 1px solid rgba(250,246,239,0.12); border-top: 1px solid rgba(250,246,239,0.12); rotate: 45deg; }
...
@media (max-width: 860px) {
  ...
  nav.main-nav { display: none; width: 100%; order: 3; flex-direction: column; padding: 12px 0 0; }
  nav.main-nav.open { display: flex; }
  nav.main-nav ul { flex-direction: column; gap: 10px; align-items: stretch; }
  li.nav-dropdown { position: static; }
  .nav-dd-menu { position: static; border: none; box-shadow: none; background: transparent; padding: 4px 0 4px 16px; margin-top: 0; min-width: auto; }
  .nav-dd-menu::before { display: none; }
  .nav-dd-menu a { font-size: 0.85rem; padding: 6px 12px; }
  .nav-dd-toggle { width: 100%; text-align: left; }
...
"""
  ...
  <div class="header-inner">
    ...
    <a href="{LOGIN_URL}" class="nav-login">Login</a>
